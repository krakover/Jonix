 ...
 *         &lt;element ref="{http://ns.editeur.org/onix/3.0/short}special"/>
 *         &lt;element ref="{http://ns.editeur.org/onix/3.0/short}fontstyle"/>
...
public class RubyContent {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "special", namespace = "http://ns.editeur.org/onix/3.0/short", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "fontstyle", namespace = "http://ns.editeur.org/onix/3.0/short", type = JAXBElement.class, required = false),
